...
#define FILE_PREFIX @"spx_life"
@interface SpxLifeVlg()
{
...
//35 1236 Gap 400.333
@implementation SpxLifeVlg
+(id)SpxLifeVlg
{
    SpxLifeVlg *instance = [[[NSBundle mainBundle] loadNibNamed:@"SpxLifeVlg" owner:self options:nil] lastObject];
    if( [instance isKindOfClass:[SpxLifeVlg class]] )
    {
        return instance;
    }
    else
