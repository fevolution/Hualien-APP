...
#define FILE_PREFIX @"spx_culcreate"
@interface SpxCulcreate()
{
...
//35 1236 Gap 400.333
@implementation SpxCulcreate
+(id)SpxCulcreate
{
    SpxCulcreate *instance = [[[NSBundle mainBundle] loadNibNamed:@"SpxCulcreate" owner:self options:nil] lastObject];
    if( [instance isKindOfClass:[SpxCulcreate class]] )
    {
        return instance;
    }
    else
