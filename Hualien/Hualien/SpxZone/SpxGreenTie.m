...
#define FILE_PREFIX @"spx_greentie"
@interface SpxGreenTie()
{
...
//@property(nonatomic, weak)IBOutlet UIImageView* uiIndicatorMask;
@property(nonatomic, weak)IBOutlet UIImageView* uiTitle;
@end

//35 1236 Gap 400.333
@implementation SpxGreenTie
+(id)SpxGreenTie
{
    SpxGreenTie *instance = [[[NSBundle mainBundle] loadNibNamed:@"SpxGreenTie" owner:self options:nil] lastObject];
    if( [instance isKindOfClass:[SpxGreenTie class]] )
    {
        return instance;
    }
    else
